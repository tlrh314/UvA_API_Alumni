...
class City(object):
    ...
    def __init__(self, info=None):
        ...
        :param info: A tuple of information to fill in the city info.
            ...
            See :attr:`timezone` property for a method of obtaining
            time zone names
    ...
    def latitude():
        ...
        def fset(self, latitude):
            if isinstance(latitude, stringtype):
    ...
    def longitude():
        ...
        def fset(self, longitude):
            if isinstance(longitude, stringtype):
    ...
    def timezone():
        ...
        def fset(self, name):
            ...
            try:
                self._timezone_group, self._timezone_location = name.split('/',
                                                                           1)
            except ValueError:
    ...
    def dawn(self, date=None, local=True):
        ...
        of degrees below the horizon. By default this is 6 degrees but
        can be changed by setting the :attr:`Astral.solar_depression`
        property.
...
point.)
    ...
    def sunset(self, date=None, local=True):
        ...
        0.833 degrees below the horizon. This is to account for
        refraction.)
    ...
    def dusk(self, date=None, local=True):
        ...
        certain number of degrees below the horizon. By default this
        is 6 degrees but can be changed by setting the
    ...
    def rahukaalam(self, date=None, local=True):
        ...
        rahukaalam = self.astral.rahukaalam_utc(date, self.latitude,
                                                self.longitude)
    ...
    def solar_azimuth(self, dateandtime=None):
        ...
        return self.astral.solar_azimuth(dateandtime, self.latitude,
                                         self.longitude)
    ...
    def solar_elevation(self, dateandtime=None):
        ...
        return self.astral.solar_elevation(dateandtime, self.latitude,
                                           self.longitude)
...
class Astral(object):
    ...
    def solar_depression():
        """The number of degrees the sun must be below the horizon for
        the dawn/dusk calc.
        ...
        def fset(self, depression):
            if isinstance(depression, stringtype):
                try:
                    self._depression = {'civil': 6, 'nautical': 12,
    ...
    def sun_utc(self, date, latitude, longitude):
        ...
        :type latitude:    float
        :param longitude: Longitude as a floating point number.
            Eastern latitudes should be negative
        ...
        return {'dawn': dawn, 'sunrise': sunrise, 'noon': noon,
    ...
    def dawn_utc(self, date, latitude, longitude):
        ...
        dawn = datetime.datetime(date.year, date.month, date.day,
    ...
    def solar_azimuth(self, dateandtime, latitude, longitude):
        ...
        JD = self._julianday(dateandtime.day, dateandtime.month,
                             dateandtime.year)
...
#
# bug found by martin:
# The moon phases in astral are calculated with the algorithm used by
# sky and telescope
# (http://www.skyandtelescope.com/observing/objects/javascript/moon_phases)
#
# The julian day they put in their calculation is different from the one
# used by astral. The "day" variable that goes into the equation for jd
# is modified like:
# day = day + zone + 0.5, where zone = timeoffset (in minutes)/1440.
# This modification is not used by astral, which gives a different moon
# phase in the end.
#
        timezone_offset = -60.0/1440.0
        jd = jd + timezone_offset + 0.5
#
    ...
    def _geom_mean_long_sun(self, juliancentury):
        l0 = (280.46646 + juliancentury *
              (36000.76983 + 0.0003032 * juliancentury))
        return l0 % 360.0
    ...
    def _geom_mean_anomaly_sun(self, juliancentury):
        return (357.52911 + juliancentury *
