                ...
                if activity.nr % 10 == 0:
                    ...
                    if activity.is_in_block1:
                        ...
                        if activity.max_people - nr_people == 1:
                            people1[activity.nr] = " 1 plaats beschikbaar"
                            nr_spots += 1
                        elif activity.max_people - nr_people < 1:
                            people1[activity.nr] = " Vol "
                        else:
                    ...
                    if activity.is_in_block2:
                        ...
                        if star_dict['number__sum'] is not None:
                            nr_people = star_dict['number__sum']
                        if activity.max_people - nr_people == 1:
                            people2[activity.nr] = " 1 plaats beschikbaar"
                            nr_spots += 1
                        elif activity.max_people - nr_people < 1:
                            people2[activity.nr] = " Vol "
                        else:
                    ...
                    if activity.is_in_block3:
                        ...
                        if star_dict['number__sum'] is not None:
                            nr_people = star_dict['number__sum']
                        if activity.max_people - nr_people == 1:
                            people3[activity.nr] = " 1 plaats beschikbaar"
                            nr_spots += 1
                        elif activity.max_people - nr_people < 1:
                            people3[activity.nr] = " Vol "
                        else:
