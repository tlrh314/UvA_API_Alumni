...
#
    ...
    slot1 = models.ForeignKey(Activity, related_name='slot1', default=10)
    slot2 = models.ForeignKey(Activity, related_name='slot2', default=10)
    slot3 = models.ForeignKey(Activity, related_name='slot3', default=10)
