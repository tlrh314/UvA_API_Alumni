...
class JobAfterLeavingAdmin(admin.ModelAdmin):
    ...
    actions = (
        "export_selected_jobs_to_excel",
        "export_all_jobs_to_excel",
        "export_filtered_jobs_to_excel",
    )
    extended_actions = (
        "export_all_jobs_to_excel",
        "export_filtered_jobs_to_excel",
    ...
    export_filtered_jobs_to_excel.short_description = (
        "Export filtered list of Jobs to Excel"
    )
