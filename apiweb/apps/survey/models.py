...
class JobAfterLeaving(models.Model):
    ...
    is_inside_academia = models.PositiveSmallIntegerField(
        _("In Academia"), choices=YES_OR_NO, default=1
    )
    is_inside_astronomy = models.PositiveSmallIntegerField(
        _("In Astronomy"), choices=YES_OR_NO, null=True, blank=True
    )
    ...
    which_position = models.PositiveSmallIntegerField(
        _("Which position"), choices=WHICH_POSITION_CHOICES, default=0
    )
    ...
    # Privacy
    show_job = models.BooleanField(
        _("Show job on personal page"), blank=True, default=True
    )
