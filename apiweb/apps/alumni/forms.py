...
class AlumnusAdminForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if any(unicode.isdigit(c) for c in initials):
        ...
        if last_name and any(unicode.isdigit(c) for c in last_name):
        ...
        if mobile and not any(unicode.isdigit(c) for c in mobile):
        ...
        if home_phone and not any(unicode.isdigit(c) for c in home_phone):
        ...
        if work_phone and not any(unicode.isdigit(c) for c in work_phone):
