...
LOGGING = {
    ...
    "loggers": {
        ...
        "survey": {"handlers": ["survey"], "level": "DEBUG", "propagate": True},
    },
}
...
ADMIN_MEDIA_JS = (STATIC_URL + "js/action_buttons.js",)
...
AJAX_LOOKUP_CHANNELS = {"user": {"model": "auth.user", "search_field": "username"}}
